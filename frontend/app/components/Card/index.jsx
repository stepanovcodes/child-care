...
const Card = ({ childCare, highlight }) => {
  const borderStyle = highlight ? "2px solid #009CE1" : "none";
  // console.log(highlight, borderStyle)
  return (
    <Paper className="h-48 mx-5" variant="elevation" style={{ border: borderStyle }}>
      <div className="p-2">
